...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		...
		<!-- Links -->
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="/list">야구장 목록</a></li>
			<li class="nav-item"><a class="nav-link" href="/stardiumSaveForm">야구장 등록</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="/expulsion">퇴출된 선수 목록</a></li>

			<li class="nav-item"><a class="nav-link" href="/expulsionSaveForm">퇴출 사유 등록</a></li>
		</ul>
	</nav>